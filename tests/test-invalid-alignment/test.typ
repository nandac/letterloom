...
/// - "date-alignment must be a valid alignment type." - when date-alignment is string
...
/// alignment parameters (from-alignment, date-alignment, footnote-alignment,
...
#assert.eq(
  ...
  "panicked with: \"date-alignment must be a valid alignment type.\"",
)
