/// test-letterhead-sender-position-right-bottom
///
/// Synopsis:
/// Rendering test that validates the sender-position: right, sender-valign: bottom
...
/// the bottom of the image when sender-position is right, rather than the default
...
///   appear to the right, aligned to the bottom edge of the image; letter
...
/// bottom-aligned sender placement alongside a right-position letterhead.
#import "/src/lib.typ": *
