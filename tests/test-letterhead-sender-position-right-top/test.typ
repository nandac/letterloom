/// test-letterhead-sender-position-right-top
///
/// Synopsis:
/// Rendering test that validates the sender-position: right, sender-valign: top
...
/// the top of the image when sender-position is right, rather than the default
...
///   appear to the right, aligned to the top edge of the image; letter content
...
/// sender placement alongside a right-position letterhead.
#import "/src/lib.typ": *
