...
/// footer parameters by testing type validation and content validation
/// for the `footer` field and its nested structure.
///
/// Purpose:
/// Ensures that the validation system correctly identifies and reports errors
/// when footer parameters contain invalid data types, missing required fields,
/// or invalid content.
///
/// Test Scenarios:
/// - footer field is string instead of array of dictionaries
/// - footer dictionary missing required footer-text field
/// - footer-text field has invalid type (number instead of string/content)
/// - footer-type field has invalid value (not url, email, or string)
///
/// Expected Behavior:
...
///
/// Expected Errors:
/// - "footer element 'invalid footer' must be a dictionary." - when footer element is not a dictionary
/// - "footer-text is missing." - when footer-text field is missing
/// - "footer-text '4' must be a string or content block." - when footer-text has wrong type
/// - "footer-type 'invalid footer type' must be one of url, email or string." - when footer-type has invalid value
///
/// Validation:
...
/// Tests both structure validation (missing fields) and type validation (wrong types, invalid values).
///
/// Note:
/// This test validates that the footer field, which is optional, must be properly
/// formatted when provided. It ensures type safety and content validation
/// for footer elements and their nested fields.
#import "/src/lib.typ": *
